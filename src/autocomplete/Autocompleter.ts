...
import CommandProvider from "matrix-react-sdk/src/autocomplete/CommandProvider";
...
const PROVIDERS = [UserProvider, RoomProvider, EmojiProvider, NotifProvider, SpaceProvider, CommandProvider];
        ...
        return filterBoolean(
            completionsList.map((completions, i) => {
                ...
                return {
                    ...
                    /* the currently matched "command" thconsole.log(querye completer tried to complete
