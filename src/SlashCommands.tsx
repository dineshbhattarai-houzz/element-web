...
import { isCurrentLocalRoom, reject, singleMxcUpload, success, successSync } from "matrix-react-sdk/src/slash-commands/utils";
...
export function setCommands(commands: Command[]){
    ...
    // build a new map from names and aliases to the Command objects.
    CommandMap.clear();
